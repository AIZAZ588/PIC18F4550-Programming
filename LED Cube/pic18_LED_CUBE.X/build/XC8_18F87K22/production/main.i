...
void main(void) {
   TRISAbits.TRISA1 =0;TRISAbits.TRISA2=0;TRISAbits.TRISA3=0;TRISAbits.TRISA5=0;TRISBbits.TRISB0=0;TRISBbits.TRISB1=0;TRISCbits.TRISC1=0;TRISCbits.TRISC2=0;TRISCbits.TRISC6=0;TRISEbits.TRISE0=0;TRISEbits.TRISE1=0;TRISBbits.TRISB2 = 1;TRISAbits.TRISA0 =0;TRISD =0b00000000;TRISEbits.TRISE2=1;
...
void Rand(unsigned short* led ,unsigned char* LAYER)
{
   ...
   while(time<20){
        ...
        *led = (unsigned) num;
         *LAYER = (unsigned)num & 0b1111;
         LATAbits.LATA0 = (unsigned)(*led >> 0) & 0xff; LATAbits.LA1 = (unsigned)(*led >> 1) & 0xff; LATAbits.LA2 = (unsigned)(*led >> 2) & 0xff; LATAbits.LA3 = (unsigned)(*led >> 3) & 0xff; LATAbits.LA5 = (unsigned)(*led >> 4) & 0xff; LATCbits.LC1 = (unsigned)(*led >> 5) & 0xff; LATCbits.LC2 = (unsigned)(*led >> 6) & 0xff; LATCbits.LC6 = (unsigned)(*led >> 7) & 0xff; LATDbits.LATD0 = (unsigned)(*led >> 8) & 0xff; LATDbits.LATD1 = (unsigned)(*led >> 9) & 0xff; LATDbits.LATD2 = (unsigned)(*led >> 10) & 0xff; LATDbits.LATD3 = (unsigned)(*led >> 11) & 0xff; LATDbits.LATD4 = (unsigned)(*led >> 12) & 0xff; LATDbits.LATD5 = (unsigned)(*led >> 13) & 0xff; LATDbits.LATD6 = (unsigned)(*led >> 14) & 0xff; LATDbits.LATD7 = (unsigned)(*led >> 15) & 0xff;
         LATBbits.LATB0 = (unsigned)(*LAYER >> 0) & 0xf; LATBbits.LATB1 = (unsigned)(*LAYER >> 1) & 0xf; LATEbits.LE0 = (unsigned)(*LAYER >> 2) & 0xf; LATEbits.LE1 = (unsigned)(*LAYER >> 3) & 0xf;
         *led=0;*LAYER=0;
          delay_100ms(7);
